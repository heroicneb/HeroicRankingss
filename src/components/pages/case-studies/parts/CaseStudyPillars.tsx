...
function PillarCard({ pillar, className }: PillarCardProps) {
  ...
  return (
    ...
    >
      ...
      <h3 className="font-normal text-[22px] leading-[1.2] tracking-[-0.44px] text-[var(--color-hr-pure-black)] lg:text-[32px] lg:tracking-[-0.64px] dark:text-[var(--color-text-inverse)]">
        {pillar.title}
      </h3>
