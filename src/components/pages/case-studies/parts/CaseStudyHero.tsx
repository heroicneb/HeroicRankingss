 ...
 *
 * Renders the "/ Case Study /" section label, a two-tone H1 (gradient + solid
 * black), and an optional subtitle. The 3 metric tiles below the H1 are
 * delegated to {@link CaseStudyHeroPanel} so a missing `heroMetrics` array
 * does not leave a gap underneath the title.
 */
